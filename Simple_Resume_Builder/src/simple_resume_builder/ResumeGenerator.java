...
public class ResumeGenerator extends javax.swing.JFrame {
    ...
    private void txt_firstnameActionPerformed() {
        
    }

    private void txt_add2ActionPerformed() {}
    

    private void txt_qual1ActionPerformed() {}

    private void txt_skill2ActionPerformed() {}

    private void txt_skill4ActionPerformed() {}

    private void txt_searchComponentRemoved() {}
